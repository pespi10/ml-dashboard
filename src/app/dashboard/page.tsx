...
function SectionSkeleton({ height = 280 }: { height?: number }) {
  return <div className="skeleton" style={{ height, borderRadius: "12px" }} />;
}
...
export default function DashboardPage() {
  ...
  return (
    <div>
      ...
      {/* Stat cards — cargan primero desde el overview rápido */}
      <div style={{
        display: "grid",
        ...
        <StatCard
          ...
          value={overview.activeItems.toString()}
          subvalue={`${overview.pausedItems} pausadas`}
          accent="yellow"
          delay={180}
        />
      </div>
      ...
      {/* Top productos + alertas de stock — lazy */}
      <div style={{
        display: "grid",
